	...
	<%@include file="/managers/top.jsp"%>
        <div id="page-wrapper">
			<div class="col-md-12 graphs">
				<div class="xs">
					<h3>简介列表  <button type="button" class="btn-primary btn" onclick="add()">增加</button></h3>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h2 class="modal-title">简介添加</h2>
								</div>
								<div class="modal-body">
									<form  id="add" method="post" action="<%=Const.ROOT%>muscle_add"class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" ng-submit="submit()">
										<fieldset>
											<div class="form-group">
												<label class="control-label">简介类型</label>
												<select type="text"  class="form-control1 ng-invalid ng-invalid-required ng-touched" name="muscle.type"  required>
													<option value="肌肉">肌肉</option>
													<option value="骨骼">骨骼</option>
												</select>
											</div>
											<div class="form-group">
												<label class="control-label">简介标题</label>
												<input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="muscle.title"  required>
											</div>
											<div class="form-group">
												<label class="control-label">简介内容</label>
												<textarea style="height: 100px" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="muscle.content"  required></textarea>
											</div>
										</fieldset>
									</form>
								</div>
					...
					<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
									<h2 class="modal-title">简介修改</h2>
								</div>
								<div class="modal-body">
									<form id="update" method="post" action="<%=Const.ROOT%>muscle_doupdate" class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" novalidate="novalidate" ng-submit="submit()">
										<input type="hidden" name="muscle.id" id="id"/>
										<fieldset>
											<div class="form-group">
												<label class="control-label">简介类型</label>
												<select type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="type" name="muscle.type" required="">
													<option value="肌肉">肌肉</option>
													<option value="骨骼">骨骼</option>
												</select>
											</div>
											<div class="form-group">
												<label class="control-label">简介标题</label>
												<input type="text" id="title" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="muscle.title"  required>
											</div>
											<div class="form-group">
												<label class="control-label">内容</label>
												<textarea style="height: 100px" class="form-control1 ng-invalid ng-invalid-required ng-touched"  id="content"  name="muscle.content"  required=""></textarea>
											</div>
										</fieldset>
									</form>
								</div>
...
<script>
    ...
    function goPage(page){
        location="muscle_list?pageBean.pageNo="+page;
    }
    ...
    function toupdate(id){
        $.getJSON("<%=Const.ROOT%>musclejson_toupdate",{id:id},function(data){
    ...
    function dodelete(){
        ...
        location="<%=Const.ROOT%>muscle_delete?id="+id;
    }
</script>
</body>
</html>
