...
<body>
    ...
    <div class="container">
        <form class="form-horizontal" action="<%=basePath%>garbageOrder/retrieve" method="post">
            ...
            <div class="form-group">
                <label  class="col-md-2  col-sm-2 control-label">垃圾类型:</label>
                <div class="col-md-8 col-sm-10" style="width:500px">
                    <select class="form-control" name="garbagetypeid">
                        <option name="gan" id="gan">干垃圾</option>
                        <option name="shi" id="shi">湿垃圾</option>
                        <option name="hui" id="hui">可回收物</option>
                        <option name="hai" id="hai">有害垃圾</option>
                    </select>
            ...
            <div class="form-group">
                <label  class="col-md-2  col-sm-2 control-label">我的地址:</label>
                <div class="col-md-8 col-sm-10" style="width:500px">
    ...
    <div class="modal fade" id="registModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel2">会员注册</h4>
                </div>
